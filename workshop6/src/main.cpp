	...
	public:
		...
		int initFont() {
			...
			if (FT_New_Face(ft, "/Users/gelzonexunsas/Library/Fonts/Tanugo-TTF-Regular.ttf", 0, &face)) {
	...
	void render() {
        ...
        RenderText(textProg, "But not these ones tho :(", 10.0f, 220.0f, 1.0f, glm::vec3(0.9, 0.5f, 0.9f));
